...
export const Link = ({ children, onClick, href }: { children: ReactNode, onClick?: () => void, href?: string }) => (
    <a className="text-sky-400 hover:underline hover:cursor-pointer" href={href} onClick={onClick}>{children}</a>
)
